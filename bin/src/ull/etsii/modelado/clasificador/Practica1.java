...
import src.ull.etsii.modelado.clasificador.modelo.Clasificador;
import src.ull.etsii.modelado.clasificador.modelo.Clasificador.MetodoClasificacion;
import src.ull.etsii.modelado.clasificador.modelo.Clasificador.TipoDistancia;
import src.ull.etsii.modelado.clasificador.modelo.Clasificador.TipoPesadoAtributos;
import src.ull.etsii.modelado.clasificador.modelo.Clasificador.TipoProcesado;
...
import ull.etsii.modelado.clasificador.modelo.Atributo;
import src.ull.etsii.modelado.clasificador.modelo.*;

import java.util.*;

/**
 * Pr�ctica de clasificaci�n que implementa como clase principal la clase Clasificator
...
public class Practica1 
{
	...
	/**
	 * @param args (String) Array de argumentos que acepta el m�todo main.
	 */
	public static void main(String[] args) 
	{	
		new Practica1().run();  /*añado un comentario*/
	}
	...
	public void run()
	{
		...
		try 
		{
			...
			System.out.print("Introduzca el tipo de procesado, (0 = Normalizaci�n, 1 = Estandarizaci�n)...:");
			System.out.println();
			value = br.readLine();
			m_TipoProcesado = TipoProcesado.values()[Integer.parseInt(value)];
			
			System.out.print("Introduzca el m�todo de clasificaci�n, (0 = Por defecto, 1 = Cercan�a, 2 = Voto fijo)...:");
			System.out.println();
			value = br.readLine();
			
			m_MetodoClasificacion = MetodoClasificacion.values()[Integer.parseInt(value)];
			
			System.out.print("Introduzca el tipo de pesado para los atributos, (0 = Est�tico, 1 = Din�mico)...:");
			System.out.println();
			value = br.readLine();
			m_TipoPesadoAtributos = TipoPesadoAtributos.values()[Integer.parseInt(value)];
			
			System.out.print("Introduzca el tipo de c�lculo para las distancias, (0 = Euclidea, 1 = Manhattan, 2 = Chebychef)...:");
			System.out.println();
			value = br.readLine();
			...
			*/
			...
			//System.out.print("Introduzca n� de vecinos...:");
			//System.out.println();
			...
			if((value.equals("s")) || (value.equals("S")))
			{
				...
				if((value.equals("s")) || (value.equals("S")))
				{
					new Aleatorio(0, m_Clasificator.getMuestras().length-1);
				...
				else
				{
					...
					System.out.println("** Nota: n� de orden 1 representa la primera muestra.");
					System.out.print("Introduzca los n�meros de orden de las muestras, " + 
	...
	/**
	 * M�todo que imprime el resumen de datos de la clase Clasificator.
	 */
	...
	/**
	 * M�todo para pedir al usuario los valores por pantalla y clasificar la muestra.
	 */
	/*
	private static void pedirValoresMuestra()
	{
		...
		for(int r = 0; r < tam; r++)
		{
			...
			try 
			{
				...
				if(m_TipoProcesado == TipoProcesado.NORMALIZACI�N)
				{
		...
		System.out.println();
		System.out.println("* Listado de las " + m_Clasificator.getVecinos() + " muestras m�s pr�ximas");
		imprimirMuestras(0, m_Clasificator.getVecinos());
	...
	*/
	...
	private static void imprimirResultadosConjuntoEntrenamiento()
	{
		...
		MatrizConfusion mc = new MatrizConfusion(m_Clasificator.getConjuntoEntrenamiento(), m_Clasificator.getDataSetInfo());
		...
		for(int r = 0; r < tam; r++)
		{
			...
			/*
			System.out.println("\t* N�" + m_Aleatorio.getNumerosGenerados()[r] + 
					"\t" + m_Clasificator.getConjuntoEntrenamiento()[r].toString() + 
					"\t    " + m_Clasificator.getConjuntoEntrenamiento()[r].isCoincidente());
			*/
		}
		System.out.println();
		System.out.println("* Matriz  de  confusi�n");
		...
		System.out.println("\t0 = La primera fila indica el tipo real, la primera columna la predicci�n.");
		...
		System.out.println();
		System.out.println("* Precisi�n predictiva del algoritmo");
	...
	/**
	 * M�todo para imprimir por pantalla las muestras de la clase Clasificator.
