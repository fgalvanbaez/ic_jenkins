 ...
 * Matriz de confusi�n para la representacion de datos estadisticos
 */
public class MatrizConfusion 
{
	...
	private Map<String, Integer> m_DataSetInfo;
	...
	/**
	 * Obtiene una matriz de enteros que representa la matriz de confusi�n siendo la 
	 * primera fila la leyenda para la clasificaci�n real y la primera columna la
	...
	public int[][] getDatos()
	{
		...
		for(int r = 0; r < tam; r++)
		{
			...
			if (!("0x" == predictValue) && (m_Muestras[r].isCoincidente()))
			{
				this.m_Aciertos++;
