...
public class Aleatorio extends Random
{
	...
	/**
	 * Obtiene los numeros aleatorios que gener� en la llamada
	 * a la funci�n generarAleatorios(int cantidad)
	 * @return int[]
	 */
	...
	/**
	 * Genera una cantidad especifica de numeros aleatorios sin repetici�n
