...
public class Muestra 
{
	 ...
	 * @param posClase (int) Valor num�rico que representa la posici�n de la columna de clasificaci�n
	...
	/**
	 * Establece el valor de clasificaci�n de la muestra.
	 * @param clasificacion (String) Cadena que representa la clasificaci�n de la muestra.
	 */
	...
	/**
	 * Obtiene el valor de clasificaci�n del objeto seg�n los valores de la muestra.
	 * @return (String) Cadena que representa la clasificaci�n del objeto.
	 */
	...
	/**
	 * Establece la predicci�n para la muestra seg�n el algoritmo knn.
	...
	/**
	 * Obtiene el resultado de la predicci�n para la muestra seg�n el algoritmo knn.
	...
	/**
	 * Obtiene un valor que indica si la predicci�n coincide con la clasificaci�n real de la muestra.
	 * @return Boolean True en caso de que la predicci�n coincida con el la clasificaci�n real de la muestra, 
	...
	/**
	 * @return (Boolean) Retorna true si, y s�lo si todos los valores de todos sus
	...
	public boolean equals(Object muestra)
	{
		...
		Muestra mAux = null;
		int tam = 0, index = -1;
		if((muestra instanceof Muestra) && (this.getAtributos().length == ((Muestra) muestra).getAtributos().length))
		{
	...
	{
		return "Tipo...: " + this.getClasificacion() + "             \tPredicci�n...: " + this.getPrediccion();
	}
	
	/**
	 * Convierte una cadena de valores separados por comas en los valores y la clasificaci�n de la muestra.
	 * @param values (String) Cadena separada por comas que representa los valores de la
	 * muestra y su clasificaci�n
	 * @param pos (int) Indice de base 0 que indica la posici�n de la columna que
