...
public class Atributo
{
	...
	private boolean mIsNormalizado;
	private boolean mIsEstandarizado;
	...
	/**
	 * Establece el t�tulo del atributo.
	...
	/**
	 * Obtiene el t�tulo del atributo.
	...
	/**
	 * Obtiene el valor m�ximo que toma el atributo en el conjunto de muestras.
	 * @return (Double) Valor m�ximo del atributo
	 */
	...
	/**
	 * Funci�n que normaliza el valor atributo en un rango entre 0 y 1 en funci�n
	 * de los valores m�ximo y m�nimo que tenga el atributo.
	...
	/**
	 * Normaliza la desviaci�n tipica del atributo en un rango 0-1.
	...
	/**
	 * Obtiene el valor real del atributo que ten�a antes de haber sido normalizado.
